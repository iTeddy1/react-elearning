...
export const InterviewPage: React.FC = () => {
  ...
  const generateReviewMutation = useGenerateInterviewReviewMutation({
    onSuccess: (review) => {
      setReviewError(null); // Clear any previous errors
      if (currentSession) {
  ...
  // Handle retry review generation
          ...
          <Card className="border-red-200 bg-red-50">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-red-700">
                The AI service may be overloaded or experiencing issues. Your
                interview responses are saved and you can retry generating the
                review.
              </p>
